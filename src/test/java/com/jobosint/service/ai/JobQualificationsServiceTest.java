...
@SpringBootTest
public class JobQualificationsServiceTest {

    @Autowired private JobQualificationsService jobQualificationsService;

    @Test
    public void test() {
        Optional<JobQualifications> maybeJobQualifications = jobQualificationsService
                .parseJobDescription("""
        ...
        System.out.println(maybeJobQualifications);
    }
}
