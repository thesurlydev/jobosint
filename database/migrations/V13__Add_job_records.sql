...
insert into jobosint.jobosint.job(title, company) values('Analyst', (select id from jobosint.jobosint.company where name = 'Microsoft'));
insert into jobosint.jobosint.job(title, company) values('Devops Engineer', (select id from jobosint.jobosint.company where name = 'Facebook'));
